...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      ...
      data-[hover=true]:border-primary-400 data-[hover=true]:bg-primary-600
      data-[active=true]:border-primary-500 data-[active=true]:bg-primary-700`,
      secondary: `border-secondary-300 bg-secondary-500
      data-[focus-visible=true]:web:ring-indicator-info
      data-[hover=true]:border-secondary-400 data-[hover=true]:bg-secondary-600
      data-[active=true]:border-secondary-700 data-[active=true]:bg-secondary-700`,
      positive: `border-success-300 bg-success-500
      data-[focus-visible=true]:web:ring-indicator-info
      data-[hover=true]:border-success-400 data-[hover=true]:bg-success-600
      data-[active=true]:border-success-500 data-[active=true]:bg-success-700`,
      negative: `border-error-300 bg-error-500 data-[focus-visible=true]:web:ring-indicator-info
      data-[hover=true]:border-error-400 data-[hover=true]:bg-error-600
      data-[active=true]:border-error-500 data-[active=true]:bg-error-700`,
      default: `bg-transparent data-[hover=true]:bg-background-50
      data-[active=true]:bg-transparent`,
    },
    variant: {
      link: "px-0",
      outline: `border bg-transparent data-[hover=true]:bg-background-50
      data-[active=true]:bg-transparent`,
      solid: "",
    },
  ...
  compoundVariants: [
    {
      action: "primary",
      variant: "link",
      class: `bg-transparent px-0 data-[hover=true]:bg-transparent
      data-[active=true]:bg-transparent`,
    },
    {
      action: "secondary",
    ...
    },
    {
      action: "primary",
      variant: "outline",
      class: `bg-transparent data-[hover=true]:bg-background-50
      data-[active=true]:bg-transparent`,
    },
    {
      action: "secondary",
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      ...
      positive: `text-success-600 data-[hover=true]:text-success-600
  ...
  parentCompoundVariants: [
    ...
    },
    {
      variant: "outline",
      action: "primary",
      class: `text-primary-500 data-[hover=true]:text-primary-500
      data-[active=true]:text-primary-500`,
    },
    {
      variant: "outline",
      action: "secondary",
      class: `text-typography-500 data-[hover=true]:text-primary-600
      data-[active=true]:text-typography-700`,
    },
    {
      variant: "outline",
